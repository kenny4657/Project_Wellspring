...
void main() {
    ...
    if (isWall) {
        ...
        // so the base color stays as the surrounding sand/beach instead of
        // a washed-out transition band.
        ...
        // Apply water-hex cliff rock LAST: overlays on top of beach/sand
        // so the bottom edge fades cleanly from rock to neighbor sand color
